...
def plot_pareto_curve_only(checkpoint_base_dir, output_file='results/tuning/weight_pareto_only.png'):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--output', type=str, default='results/tuning/weight_pareto_only.png',
